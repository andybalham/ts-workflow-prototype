...
import { FlowHandlers, IActivityRequestHandler } from "./FlowHandlers";
import { FlowContext } from "./FlowContext";
import { IFlowInstanceRepository } from "./FlowInstanceRepository";

function f() {

    const context = new FlowContext(new InstanceRespository());
...
class InstanceRespository implements IFlowInstanceRepository {
    save(flowInstance: import("./FlowInstanceRepository").FlowInstance) {
        throw new Error("Method not implemented.");
    }
    load(instanceId: string): import("./FlowInstanceRepository").FlowInstance {
        throw new Error("Method not implemented.");
    }
}
